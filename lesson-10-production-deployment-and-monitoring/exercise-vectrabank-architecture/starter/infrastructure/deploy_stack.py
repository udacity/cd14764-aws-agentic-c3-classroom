...
deploy_stack.py
===============
Deploys the Lesson 10 Exercise CloudFormation infrastructure using boto3.
Run this ONCE before the VectraBank exercise.

No AWS CLI required — uses boto3 directly.

Usage:
    cd lesson-10-production-deployment-and-monitoring/exercise-vectrabank-architecture/starter/infrastructure
...
PROJECT_NAME  = "lesson-10-exercise"
...
def _print_outputs(stack: dict):
    ...
    print("\n" + "=" * 60)
    print("  Lesson 10 Exercise Infrastructure — Ready")
    print("=" * 60)
    print(f"\n  AgentCore Role ARN:")
    ...
    print(f"  The lesson script discovers them automatically.\n")
    print(f"  You are ready to run:")
    print(f"    python vectrabank_architecture.py\n")
