...
The helper reads the role and guardrail from the `lesson-10-demo-runtime` stack.
...
In the CloudFormation console, delete `AgentCore-lesson10demo-default` and wait for
